...
This repository contains the data instances, detailed experimental results, and source code for the paper: **Modeling the Equilibrium of Global Shipping Markets: A Cyclic Space-time Supernetwork Approach**.
